...
def make_xml_invoice(inv, tipo_documento, consecutivo, date, sale_conditions, medio_pago, total_servicio_gravado,
                     ...
                     codigo_referencia, razon_referencia, url, currency_rate, invoice_comments):
    headers = {}
    payload = {}
    # Generar FE payload
    payload['w'] = 'genXML'
    ...
    payload['emisor_num_identif'] = api_facturae.limit(inv.company_id.vat, 20)
    ...
    payload[
        'emisor_barrio'] = inv.company_id.neighborhood_id and inv.company_id.neighborhood_id.code or ''  # inv.company_id.neighborhood_id.code or ''
    ...
    payload['receptor_tel'] = inv.partner_id.phone and re.sub('[^0-9]+', '',
                                                              inv.partner_id.phone) or ''  # re.sub('[^0-9]+', '', inv.partner_id.phone)
    ...
    payload['otros'] = invoice_comments
