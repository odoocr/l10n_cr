...
def load_xml_data_from_mail(invoice, load_lines, account_id, product_id=False, analytic_account_id=False):
    ...
    if partner:
        ...
        invoice.message_post(
            body='El proveedor no existe, fue creado automaticamente por favor reviselo.')
        _logger.info('The provider in the invoice does not exists. But was create automatically, Please review it.')
