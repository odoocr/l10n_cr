...
class AccountInvoiceElectronic(models.Model):
    ...
    xml_respuesta_tributacion = fields.Binary(string="XML Tributación Response", copy=False,
    ...
    def action_invoice_sent_mass(self):
        ...
        if self.env.user.company_id.frm_ws_ambiente == 'disabled':
            ...
            domain = [('res_model', '=', 'account.move'),
                      ('res_id', '=', self.id),
                      ('name', 'like', self.tipo_documento + '_' + self.number_electronic)]
            ...
            try:
                ...
                if not inv.xml_comprobante or (inv.tipo_documento == 'FEC' and inv.state_tributacion == 'rechazado'):
                    ...
                    if abs(base_subtotal + total_impuestos +
                        ...
                        inv.message_post(
                            subject='Error',
                            body='Monto factura no concuerda con monto para XML. '
