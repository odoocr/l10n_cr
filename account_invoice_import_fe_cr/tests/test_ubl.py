    ...
    def test_import_fe_cr_invoice(self):
        sample_files = {
            'UBLKetentest_Referentiefactuur_20150100.xml': {
                ...
                'due_date': '2015-02-16',
                'partner_xmlid': 'account_invoice_import_fe_cr.ketentest',
                },
            'efff_BE0505890632_160421_Inv_16117778.xml': {
                ...
                'due_date': '2016-04-28',
                'partner_xmlid': 'account_invoice_import_fe_cr.exact_belgium',
                },
            'UBLInvoice-multitankcard-line_adjust.xml': {
                ...
                'partner_xmlid': 'account_invoice_import_fe_cr.multi_tank',
                },
            }
        ...
        for (sample_file, res_dict) in sample_files.iteritems():
            f = file_open(
                'account_invoice_import_fe_cr/tests/files/' + sample_file,
                'rb')
            pdf_file = f.read()
            f.close()
            wiz = aiio.create({
